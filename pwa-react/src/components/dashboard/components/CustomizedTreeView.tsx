...
const CustomTreeItem = React.forwardRef(function CustomTreeItem(
  ...
  const color = undefined; // item?.color;
  return (
...
// Make sure TreeItem2Provider properly returns a valid JSX element
const TreeItem2Provider: React.FC<{ itemId: string; children: React.ReactNode }> = ({
  itemId,
  children
}) => {
  // Your provider logic here
  return <>{children}</>; // Ensure it always returns a valid JSX element
};
